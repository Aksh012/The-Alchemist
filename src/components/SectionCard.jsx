  ...
  return (
    <div className="max-w-8xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-center text-lg text-gray-500 mb-12">
        Explore a wide variety of time-honored practices designed to promote
        holistic wellness and rejuvenate your body and mind.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
        {offerings.map((offering, index) => (
          <div
            key={index}
            className={`p-6 ${offering.bgColor} rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300`}
          >
